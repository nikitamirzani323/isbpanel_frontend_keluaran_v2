                                ...
                                <tbody>
                                    {#each listkeluaran as rec}
                                        <tr>
                                            ...
                                            <td class="text-xs text-left">{rec.pasaran_diundi}</td> 
                                            <td class="text-xs text-center">{convert_time(rec.pasaran_jamjadwal)}</td> 
...
{:else}
    <section class="w-full">
        <aside class="tabs tabs-boxed mb-2">
            <a 
                on:click={() => {
                    handleTabMobile_1("tab_mobile_keluarantogel");
                }}
                class="tab {tab_mobile_keluarantogel} text-xs">Keluaran Togel</a> 
            <a 
                on:click={() => {
                    handleTabMobile_1("tab_mobile_prediksitogel");
                }}
                class="tab {tab_mobile_prediksitogel} text-xs">Prediksi Togel</a>
        </aside>
        <aside class="card w-full bg-base-300 shadow-xl text-neutral-content rounded-md mb-2">
                    ...
                    {#if listkeluaran != ""}
                        ...
                        <div class="overflow-x-auto">
                            <table class="table table-compact w-full">
                                <thead>
                                    <tr>
                                        <th class="text-[11px] text-left">PASARAN</th> 
                            ...
                            <table class="table table-compact w-full">
                                <thead>
                                    <tr>
                                        <th class="text-[11px] text-left">PASARAN</th> 
                                        <th class="text-[11px] text-center">TANGGAL</th> 
                                        <th class="text-[11px] text-center">BBFS</th> 
                                        <th class="text-[11px] text-center">NOMOR</th>
                                    </tr>
                                </thead> 
                                <tbody>
                                    {#each listkeluaran as rec}
                                        <tr>
                                            <td class="text-[11px] text-left">{rec.pasaran_name}</td> 
                                            <td class="text-[11px] text-center">{rec.pasaran_dateprediksi}</td> 
        ...
        <section class="mb-4">
                    ...
                    <div class="card-body p-1 mb-2">
                        <div class="overflow-x-auto">
                            <table class="table table-compact w-full">
                                <thead>
                                    <tr>
                                        <th class="text-[11px] text-center bg-accent text-base-300 border-none">HARI</th> 
                                        <th class="text-[11px] text-center bg-accent text-base-300 border-none">PON</th> 
                                        <th class="text-[11px] text-center bg-accent text-base-300 border-none">WAGE</th> 
                                        <th class="text-[11px] text-center bg-accent text-base-300 border-none">KLIWON</th> 
                                        <th class="text-[11px] text-center bg-accent text-base-300 border-none">LEGI</th>
                                        <th class="text-[11px] text-center bg-accent text-base-300 border-none">PAHING</th>
                                    </tr>
                                </thead> 
                                <tbody>
                                    <tr>
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">SENIN</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">89102</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">67890</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">23456</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">01234</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">67890</td>
                                    </tr>
                                    <tr>
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">RABU</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">90123</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">89012</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">67890</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">56789</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">34576</td>
                                    </tr>
                                    <tr>
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">KAMIS</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">67890</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">23456</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">45678</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">01234</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">23456</td>
                                    </tr>
                                    <tr>
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">SABTU</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">34567</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">67890</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">23456</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">56789</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">12345</td>
                                    </tr>
                                    <tr>
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">MINGGU</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">56789</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">01234</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">01234</td> 
                                        <td class="text-[11px] text-center bg-accent text-base-300 border-none font-semibold">56789</td> 
            ...
            {#if panel_1_2}
                <aside class="card w-full bg-accent shadow-xl text-neutral-content rounded-md">
                    <div class="card-body p-1 mb-2 bg-accent rounded-none">
                        <div class="overflow-x-auto">
                            <table class="table table-compact w-full">
                                <thead class="rounded-none">
                                    <tr>
                                        <th class="text-[11px] text-center bg-accent text-black">SHIO</th> 
                                        <th class="text-[11px] text-center bg-accent text-black" colspan="9">ANGKA</th>
                                    </tr>
                                </thead> 
                                <tbody>
                                    {#each datashio as shio}
                                        ...
                                        {#each shio as dt, j}
                                            {#if j === 0}
                                            <td class="text-[11px] text-center bg-accent text-black border-none font-semibold">{shio[j]}</td>
                                            {:else}
                                            <td class="text-[11px] text-center bg-accent text-black border-none font-semibold">{shio[j]}
                                            </td>
                                            {/if}
                                        {/each}
                                        </tr>
                    ...
                    <div class="card-body p-2 mb-2 ">
                        <div class="overflow-x-auto">
                            <table class="table table-compact w-full">
                                <tbody>
                                    <tr>
                                        <td class="text-[11px] text-center bg-accent text-base-300 font-semibold">
                                            01 05 95 12 45<br />
                                            02 16 53 09 35<br />
                                            03 32 52 85 52<br />
                                            04 12 65 05 15<br />
        ...
        <aside class="tabs tabs-boxed mb-2">
            <a 
                on:click={() => {
                    handleTabMobile_2("tab_mobile_news");
                }}
                class="tab {tab_mobile_news} text-xs">Berita Hari Ini</a> 
            <a 
                on:click={() => {
                    handleTabMobile_2("tab_mobile_newsmovie");
                }}
                class="tab {tab_mobile_newsmovie} text-xs">Movie Minggu Ini</a>
        </aside>
        <aside class="card w-full bg-base-300 shadow-xl text-neutral-content rounded-md mb-2">
                                    ...
                                    <div class="card w-full bg-base-300 text-neutral-content rounded-none border-b-2 border-primary-focus">
                                        <div class="card-body p-2 mb-2">
                                            <img class="w-full h-1/2" 
                                                use:lazy="{{src: rec.news_image}}" 
                                                src="{imgdummy}" alt="{rec.news_title}">
                                            <h2 class="font-semibold text-xs underline">{rec.news_title}</h2>
                                            <p class="text-xs text-base-content/70">
                                                {rec.news_descp}
                                            </p>
                                        </div>
